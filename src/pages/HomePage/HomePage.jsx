...
function HomePage() {
  ...
  const handleSumbit = async (e) => {
    e.preventDefault();
    try {
      const res = await axios.post("https://mindserver-production.up.railway.app/directory/create", {
  ...
  const handleSumbitBlog = async (e) => {
    e.preventDefault();
    try {
      const res = await axios.post("https://mindserver-production.up.railway.app/blog/create", {
        title: blogTitle,
        body: blogBody,
        source: blogFuente
      })
  ...
  const handleSumbitCategory = async (e) => {
    e.preventDefault();
    try {
      const res = await axios.post("https://mindserver-production.up.railway.app/createCategory", {
                ...
                <div className="homePage_container_pretty">
                  <div className="homePage_container_top">
                    ...
                    <div className="homePage_container_topRight">
                      <Link to="/chat" className='container_top_right'>
